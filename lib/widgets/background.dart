    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          // Role Selection using CustomTextField with dropdown functionality
          GestureDetector(
            onTap: () async {
            ...
            child: AbsorbPointer(
              child: CustomTextField(
                controller: TextEditingController(text: _selectedRole[0].toUpperCase() + _selectedRole.substring(1)),
                label: 'Select Role',
          ...
          // Country Selection using CustomTextField with picker functionality
          GestureDetector(
